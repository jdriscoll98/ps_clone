...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VueRaven"] = factory();
	else
		root["VueRaven"] = factory();
})(this, function() {
...
var RavenConstructor = __webpack_require__(7);
...
exports.version = exports.Raven = undefined;

var _ravenJs = __webpack_require__(3);
...
function plugin(Vue) {
  ...
  if (_options.disableReport) {
    ...
    // fake api
    ;['captureException'].forEach(function (method) {
      api[method] = function () {
        return false;
      };
    });
  ...
  if (!_options.dsn || !_options.dsn.length) {
    _options.dsn = _options.protocol + '://' + _options.public_key + (':' + _options.private_key + '@' + _options.host + _options.path + _options.project_id);
  }
  ...
  // config raven
  _ravenJs2.default.config(_options.dsn, _options.config);

  if (!_options.disableAutoReport) {
    _ravenJs2.default.addPlugin(_vue2.default, Vue);
  }
  ...
  // add raven instance
  Vue.prototype.$raven = _ravenJs2.default;
}
